...
import com.arapeak.adkya.PrefManager;
    ...
    private void launchHomeScreen() {
        ...
        if (Connectivity.isConnectedWifi(getApplicationContext())) {
            ...
            if (Common.retrieveUserDataPreferance(getApplicationContext()) == null) {
                ...
                //no need to check if user login via socail or not because i check in login acivity
                startActivity(new Intent(getApplicationContext(), LoginActivity.class));
                finish();

            }
        }else {
            Toast.makeText(StartActivity.this, "الرجاء التحقق من اتصالك في الانترنت", Toast.LENGTH_SHORT).show();
        }
    }
